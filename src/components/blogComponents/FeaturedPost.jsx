...
const FeaturedPost = () => {
    return (
        <article className='py-4'>
            <h1 className="text-4xl lg:text-5xl text-slate-700 font-bold hover:text-orange transition-all"><NavLink to='/blog'>Building Reusable Components in React Js</NavLink></h1>
